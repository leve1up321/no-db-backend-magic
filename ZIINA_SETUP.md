...
| `expiry` | انتهاء الصلاحية (بالميلي ثانية) | `Date.now() + (3600 * 1000)` |
...
- `expiry` يجب أن يكون **number** بالميلي ثانية (milliseconds)
- الحساب الصحيح: `Date.now() + (3600 * 1000)` (ساعة واحدة من الآن)
- مثال: `1730715600000` (بالميلي ثانية)
